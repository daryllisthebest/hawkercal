...
const FRIED_IDS = new Set(['char-kway-teow', 'nasi-goreng', 'nasi-goreng-id', 'mee-goreng', 'roti-prata', 'hokkien-mee', 'spring-rolls', 'lumpia-ph', 'lumpia-goreng', 'perkedel'])
const COCONUT_IDS = new Set(['nasi-lemak', 'laksa', 'green-curry', 'rendang', 'massaman-curry', 'kare-kare', 'soto-ayam', 'kare-ayam', 'bicol-express'])
...
export function getWeeklyInsights() {
  ...
  const bubbleTeaCal = bubbleTeaEntries.reduce((s, e) => s + (e.calories || 0), 0)

  // Drink breakdown for chart
...
export function seedDemoData() {
  ...
  const entries = [
    // Today (Sun): Roti Prata + Chicken Rice + Cai Png + Bubble Tea = 1,630 kcal
    { date: today, dishId: 'roti-prata',   name: 'Roti Prata',   emoji: '🫓', calories: 350,  macros: { protein: 8,  carbs: 44, fat: 17, fiber: 1 }, meal: 'breakfast', modifications: ['2 plain pratas', 'Light curry dip'] },
    ...
    { date: today, dishId: 'cai-png',      name: 'Cai Png',      emoji: '🍱', calories: 520,  macros: { protein: 22, carbs: 65, fat: 18, fiber: 4 }, meal: 'lunch',     modifications: ['3 dishes', 'Braised items'] },
    ...
    // Sat: Nasi Lemak + Bubble Tea + Hokkien Mee = 1,490 kcal
    { date: d(1), dishId: 'nasi-lemak',    name: 'Nasi Lemak',   emoji: '🍛', calories: 620,  macros: { protein: 20, carbs: 72, fat: 28, fiber: 4 }, meal: 'breakfast', modifications: ['Fried chicken', 'Extra sambal'] },
    { date: d(1), dishId: 'bubble-tea',    name: 'Bubble Tea',   emoji: '🧋', calories: 330,  macros: { protein: 3,  carbs: 60, fat: 8,  fiber: 0 }, meal: 'snack',     modifications: ['Large', '100% sugar', 'Tapioca pearls'] },
    { date: d(1), dishId: 'hokkien-mee',   name: 'Hokkien Mee',  emoji: '🍝', calories: 540,  macros: { protein: 26, carbs: 70, fat: 20, fiber: 2 }, meal: 'dinner',    modifications: ['Regular portion', 'Standard lard'] },
    // Fri: Chicken Rice + Teh Tarik + Laksa = 1,410 kcal
    { date: d(2), dishId: 'chicken-rice',  name: 'Chicken Rice', emoji: '🍚', calories: 480,  macros: { protein: 28, carbs: 58, fat: 14, fiber: 1 }, meal: 'lunch',     modifications: ['Regular portion'] },
    { date: d(2), dishId: 'teh-tarik',     name: 'Teh Tarik',    emoji: '☕', calories: 200,  macros: { protein: 3,  carbs: 28, fat: 6,  fiber: 0 }, meal: 'snack',     modifications: ['Normal milk', 'Normal sugar'] },
    { date: d(2), dishId: 'laksa',         name: 'Laksa',        emoji: '🍜', calories: 610,  macros: { protein: 24, carbs: 68, fat: 28, fiber: 3 }, meal: 'dinner',    modifications: ['Regular bowl', 'Drank half broth'] },
    // Thu: Cai Png + Char Kway Teow = 1,200 kcal
    { date: d(3), dishId: 'char-kway-teow', name: 'Char Kway Teow', emoji: '🥘', calories: 680, macros: { protein: 22, carbs: 78, fat: 32, fiber: 2 }, meal: 'dinner', modifications: ['Regular portion', 'Normal oil'] },
    { date: d(3), dishId: 'cai-png',       name: 'Cai Png',      emoji: '🍱', calories: 520,  macros: { protein: 22, carbs: 65, fat: 18, fiber: 4 }, meal: 'lunch',     modifications: ['3 dishes', 'Braised items'] },
    // Wed: Roti Prata + Cai Png + Bubble Tea = 1,150 kcal
    { date: d(4), dishId: 'roti-prata',    name: 'Roti Prata',   emoji: '🫓', calories: 420,  macros: { protein: 12, carbs: 52, fat: 20, fiber: 2 }, meal: 'breakfast', modifications: ['2 egg pratas', 'Light curry dip'] },
    { date: d(4), dishId: 'cai-png',       name: 'Cai Png',      emoji: '🍱', calories: 460,  macros: { protein: 18, carbs: 58, fat: 14, fiber: 4 }, meal: 'lunch',     modifications: ['2 dishes', 'Veg-heavy'] },
    { date: d(4), dishId: 'bubble-tea',    name: 'Bubble Tea',   emoji: '🧋', calories: 280,  macros: { protein: 2,  carbs: 52, fat: 6,  fiber: 0 }, meal: 'snack',     modifications: ['Medium', '50% sugar'] },
    // Tue: Pad Thai + Bubble Tea = 900 kcal
    { date: d(5), dishId: 'pad-thai',      name: 'Pad Thai',     emoji: '🍜', calories: 560,  macros: { protein: 22, carbs: 68, fat: 24, fiber: 3 }, meal: 'lunch',     modifications: ['Regular portion', 'Shrimp'] },
    { date: d(5), dishId: 'bubble-tea',    name: 'Bubble Tea',   emoji: '🧋', calories: 380,  macros: { protein: 3,  carbs: 70, fat: 8,  fiber: 0 }, meal: 'snack',     modifications: ['Large', '100% sugar', 'Pudding'] },
    // Mon: Nasi Goreng + Teh Tarik = 860 kcal
    { date: d(6), dishId: 'nasi-goreng',   name: 'Nasi Goreng',  emoji: '🍛', calories: 660,  macros: { protein: 22, carbs: 82, fat: 28, fiber: 2 }, meal: 'lunch',     modifications: ['Regular portion', 'Fried egg'] },
    { date: d(6), dishId: 'teh-tarik',     name: 'Teh Tarik',    emoji: '☕', calories: 200,  macros: { protein: 3,  carbs: 28, fat: 6,  fiber: 0 }, meal: 'breakfast', modifications: ['Normal milk', 'Normal sugar'] },
  ]
