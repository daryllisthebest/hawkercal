...
export function seedDemoData() {
  ...
  const entries = [
    ...
    { date: today, dishId: 'cai-png', name: 'Cai Png', emoji: '🍱', calories: 520, macros: { protein: 22, carbs: 65, fat: 18, fiber: 4 }, meal: 'lunch', modifications: ['3 dishes', 'Braised items', 'One scoop rice'] },
    ...
    { date: twoDaysAgo, dishId: 'cai-png', name: 'Cai Png', emoji: '🍱', calories: 520, macros: { protein: 22, carbs: 65, fat: 18, fiber: 4 }, meal: 'lunch', modifications: ['3 dishes', 'Braised items'] },
  ]
